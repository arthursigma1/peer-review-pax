...
export function ContractBadge({ runDir, validationKey, mode = "validate" }: ContractBadgeProps) {
  ...
  if (mode === "legacy") {
    return (
      <span
        className="inline-flex items-center gap-1 px-2 py-0.5 rounded border text-[11px] font-mono bg-gray-50 border-gray-200 text-gray-500 select-none whitespace-nowrap"
  ...
  if (state.status === "pass") {
    return (
      <span
        className="inline-flex items-center gap-1 px-2 py-0.5 rounded border text-[11px] font-mono bg-emerald-50 border-emerald-200 text-emerald-700 select-none whitespace-nowrap"
  ...
  return (
    <span className="relative inline-flex items-center select-none">
      <span
        className="inline-flex items-center gap-1 px-2 py-0.5 rounded border text-[11px] font-mono bg-red-50 border-red-200 text-red-700 cursor-default whitespace-nowrap"
      ...
      {tooltipVisible && (
        <span
          className="absolute bottom-full right-0 mb-1.5 z-50 bg-gray-900 text-gray-100 text-[11px] font-mono leading-relaxed rounded-md px-3 py-2.5 shadow-lg whitespace-pre-wrap break-words pointer-events-none"
