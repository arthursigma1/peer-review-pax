...
const DEFAULT_CONFIG: AgentConfig = {
  agents: [
    ...
    },
    {
      ...
      input_files: ["1-universe/source_catalog.json", "docs/pax/pax-peer-assessment-framework.md", "docs/pax/pax-peer-strategy-ontology.md"],
    ...
    },
    {
      ...
      input_files: ["docs/methodology/pax-first-valuation-driver-methodology.md", "3-analysis/statistical_methodology.md", "3-analysis/statistics_metadata.json", "3-analysis/correlations.json", "3-analysis/driver_ranking.json", "3-analysis/final_peer_set.json", "5-playbook/report_metadata.json", "5-playbook/target_company_lens.json"],
